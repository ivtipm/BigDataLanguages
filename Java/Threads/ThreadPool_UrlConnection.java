...
Задачи для потоков (лямбда-функции на освнове Runnable) создаются прямо при передеаче submit.
Алтернативное решение - реализация Runnable со всей логикой выполнения запроса.
    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        for (int i = 1; i < 70; i++) {
            ...
            thread_pool.submit( () -> {
                        String page = "";
                        try {
                            page = get_page("https://zabgu.ru/php/news.php?category=1&page=" + ii);
