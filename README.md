...
2. Скачайте заголовки новостей как минимум со 100 страниц сайта zabgu.ru. (http запрос в Java: https://mkyong.com/java/java-how-to-download-web-page-from-internet/)
   ...
   * Как скачать веб-страницу: https://mkyong.com/java/java-how-to-download-web-page-from-internet/ https://github.com/VetrovSV/OOP/blob/master/examples/java/HTTP_request.md
...
2. Проинализируйте скаченные тексты:
  - найдите упоминания людей, названий факультетов
  - свой вариант на выбор
