...
*Бонус: Создайте общую таблицу для группы на общей БД. Адрес и данные для доступа есть у старосты или преподавателя. Сделайте таблицу такой, чтобы она подошла всем, кто скачивает новости.*
